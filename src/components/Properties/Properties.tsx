...
import { LiaBedSolid,LiaBathSolid, LiaRulerCombinedSolid, LiaStarSolid } from "react-icons/lia";
    ...
    return (
        <Transition className="px-4 my-8 md:py-32 md:px-40">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                {dataFilteredHouses.map(({ id, location, price, bathroom,bedrooms, image, star, meters }) => (
                    <Link
                        key={id}
                        href={`/properties/${id}`}
